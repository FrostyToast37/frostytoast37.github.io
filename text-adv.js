...
const r_h_X1Y0 =         new Room(5, 3, 1, ["E","W"], "The hallway would be completely dark without the gloomy torches on either side of the wall, providing an eerie green light. The torches look like they have been lit for centuries and never go out. The hallway continues to the east, and the west opens up into a room.");
const r_h_X2Y0 =         new Room(6, 3, 1, ["N","E","W"], "The hallway would be completely dark without the gloomy torches on either side of the wall, providing an eerie green light. The torches look like they have been lit for centuries and never go out. The hallway continues to the north and west, and the east opens up into a room.");
...
const r_h_X2Y1 =         new Room(6, 4, 1, ["N","S"], "The hallway would be completely dark without the gloomy torches on either side of the wall, providing an eerie green light. The torches look like they have been lit for centuries and never go out. The hallway continues to the south and there is a room to the north.");
